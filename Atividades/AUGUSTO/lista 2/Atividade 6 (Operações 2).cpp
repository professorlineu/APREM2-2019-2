...
cout<<" Digite 1 para obter o primeiro numero elevado ao segundo , digite 2 para obter a raiz quadrada, digite 3 para obter a raiz cubica";
cin>>icontrol ;
